...
ArcGIS 10.3.x GeoEvent Extension Most Recent Cache Iterator Processor for iterating and playing back the most recent GeoEvent cache.
...
## Features
* Most Recent Cache Iterator Processor
